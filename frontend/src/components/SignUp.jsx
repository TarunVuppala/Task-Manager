            ...
            <div className="flex items-center justify-center bg-transparent">
                <div className="min-h-screen-flex justify-center bg-white p-8 rounded-tl-2xl shadow-lg w-[500px] h-[500px] ">
                    ...
                    <form action="signup" className="flex-col" >
                        ...
                        <input type="text" name="username" id="" placeholder="email" className="border mb-4 size-full border-black rounded-[20px] py-2 px-9"/>
                        ...
                        <input type="text" name="username" id="" placeholder="confirm password" className="border size-full mb-4 border-black rounded-[20px] py-2 px-9"/>
                        <input type="text" name="username" id="" placeholder="mobile number" className="border size-full mb-4 border-black rounded-[20px] py-2 px-9"/>
                    </form>
